...
//        tenv.executeSql("select * from rule_meta_cdc").print();
        ...
        SingleOutputStreamOperator<RuleMetaBean> ruleMetaBeanStream = rowDataStream.map(new Row2RuleMetaBeanMapFunction()).filter(Objects::nonNull);
